...
import OverQuota from "../components/OverQuota";
...
function Cuisine(props) {
  ...
  const { getCuisine, cuisine, overDailyQuota} = useFetch(url, `cuisine ${params.type}`)
  ...
  return (
    ...
    >
      {overDailyQuota === true && 
			<OverQuota>
				<h2>Daily request limit to <a target="blank" href="https://spoonacular.com/food-api/">spoonacular API</a> has been reached <br/>:/ <br /> <br /> Try again tomorrow ;-)</h2>
			</OverQuota>}
